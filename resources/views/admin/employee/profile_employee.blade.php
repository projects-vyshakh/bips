...
{{--                    <p class="text-muted mb-2 font-13"><strong>Status :</strong> <span class="ml-2 ">{{$employerData['user_email']}}</span></p>--}}
        ...
        <div class="col-lg-8 col-xl-8">
            <div class="card-box">
                ...
                {!! Form::open(['url' => 'admin/handleEmployeeProfile?id='.$employerData["uuid"],'class'=>'parsley-form','name'=>'profileForm','id'=>'profileForm']) !!}
...
--}}
                    ...
                    <h5 class="mb-3 text-uppercase bg-light p-2"><i class="mdi mdi-office-building mr-1"></i> Professional Info</h5>
                    <div class="row">
                        {{--<div class="col-md-6">
                            <div class="form-group">
                                <label for="companyname">Company Name <span class="text-danger">*</span></label>
                                {!! Form::text('company',$employerData['company_name'],['class'=>'form-control','placeholder'=>'Enter  company name']) !!}
                            </div>
                        </div>--}}
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="cwebsite">Designation <span class="text-danger">*</span></label>
                                {!! Form::text('designation',$employerData['designation'],['class'=>'form-control','placeholder'=>'Enter Designation']) !!}
    ...
    @section('scripts')
        ...
        <script src="../public/assets/js/admin/profile-employer.js"></script>
    @endsection
