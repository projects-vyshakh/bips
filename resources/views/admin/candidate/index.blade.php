            ...
            @foreach($employerData as $index=>$employer)
                    ...
                    <div class="col-lg-4">
                        <div class="text-center card-box">
                            <a href="profile-candidate?id={{$employer['uuid']}}">
                            ...
                            <div class="pt-2 pb-2">
                                ...
                                <h4 class="mt-3 font-17"><a href="profile-candidate?id={{$employer['uuid']}}" class="text-dark">{{ucwords($employer['name'])}}</a></h4>
                                <p class="text-muted">
                                    @if(!empty($employer['designation']))
                                        {{ucwords($employer['designation'])}} <span> | </span>
                                    @endif

                                     <span> <a href="#" class="text-pink">{{$employer['user_email']}}</a> </span>
                                </p>
